                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="" class="form-control" value="{{ $room->name }}" placeholder="Tên phòng thuê"
                                        readonly>
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row d-flex align-items-center">
                                        ...
                                        <div class="col-10">
                                            <input type="number" class="form-control" name="earnest_amount"
                                    ...
                                    <table class="table table-sm table-create-contract">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>tháng</td>
                                                <td><input type="text" class="form-control" placeholder="Ghi chú">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Phí điện</td>
        ...
        columnDefs: [
            {
                ...
                return `<input type="checkbox" onclick="selectCustomer(this)" name="id[]" value="${row.id}" />`
                }
