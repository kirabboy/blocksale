        ...
        <div class="modal-content">
            ...
            <form id="form-edit-contract" action="{{ route('hop-dong.update', $contract->id) }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="" class="form-control"
                                        value="{{ $contract->room->name }}" placeholder="Tên phòng thuê" readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="time_start" class="date-picker form-control"
                                    placeholder="dd/mm/yy" required data-date-format='dd-mm-yyyy'
                                        value="{{ date('d-m-Y', strtotime($contract->time_start)) }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="">Ngày tính phí<sup class="text-danger">*</sup></label>
                                    <input type="text" name="time_charge" class="date-picker form-control"
                                    placeholder="dd/mm/yy" required data-date-format='dd-mm-yyyy'
                                        value="{{ date('d-m-y', strtotime($contract->time_charge)) }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="">Trạng thái<sup class="text-danger">*</sup></label>
                                    <select class="form-control" name="status" id="" readonly>
                                        <option value="0" {{ $contract->status == 0 ? 'selected' : '' }}>Chờ duyệt
                                        </option>
                                        <option value="1" {{ $contract->status == 1 ? 'selected' : '' }}>Hiệu lực
                                        </option>
                                        <option value="2" {{ $contract->status == 2 ? 'selected' : '' }}>Hết hạn
                                        </option>
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="time_end" class="date-picker form-control"
                                    placeholder="dd/mm/yy" required data-date-format='dd-mm-yyyy'
                                        value="{{ date('d-m-Y', strtotime($contract->time_end)) }}" required>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="row d-flex align-items-center">
                                        <div class="col-2 justify-content-center d-flex">
                                            <input type="checkbox" class="input-group-text" name="is_earnest"
                                                @if ($contract->is_earnest == 1) checked @endif value="1">
                                        </div>
                                        <div class="col-10">
                                            <input type="number" class="form-control" name="amount_earnest"
                                                placeholder="Tiền đặt cọc"
                                                value="{{ $contract->contractinfo->amount_earnest }}">
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control" name="note_room"
                                                        value="{{ $contract->contractinfo->note_room }}"
                                                        placeholder="Ghi chú">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td><input type="number" class="form-control" name="price_electric"
                                                        value="{{ $contract->contractinfo->price_electric }}"
                                                        placeholder="Đơn giá"></td>
                                                <td>kWh</td>
                                                <td><input type="text" class="form-control" name="note_electric"
                                                        value="{{ $contract->contractinfo->note_electric }}"
                                                        placeholder="Ghi chú">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td><input type="number" class="form-control" name="number_water"
                                                        value="{{ $contract->contractinfo->number_water }}"></td>
                                                ...
                                                <td><select name="type_water" class="form-control" id="">
                                                        <option value="1"
                                                            @if ($contract->contractinfo->type_water == 1) selected @endif>tháng
                                                        </option>
                                                        <option value="2"
                                                            @if ($contract->contractinfo->type_water == 2) selected @endif>m3
                                                        </option>
                                                    </select></td>
                                                <td><input type="text" class="form-control" name="note_water value="
                                                        {{ $contract->contractinfo->note_water }}
                                                        placeholder="Ghi chú">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td><input type="number" class="form-control" name="number_service"
                                                        value="{{ $contract->contractinfo->number_service }}"></td>
                                                ...
                                                <td><input type="text" class="form-control" name="note_service"
                                                        value="{{ $contract->contractinfo->note_service }}"
                                                        placeholder="Ghi chú">
                                                </td>
                                            </tr>
                                        </tbody>
                ...
                <div class="modal-footer">
                    ...
                    <a href="{{ route('pdf.contract', $contract->id) }}" target="_blank" class="btn btn-cyan">In
                        PDF</a>
