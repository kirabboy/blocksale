                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="time_start" class="form-control"
                                        placeholder="Ngày bắt đầu" required pattern="(?:30))|(?:(?:0[13578]|1[02])-31))/(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])/(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="time_end" class="form-control"
                                        placeholder="Ngày kết thúc" required pattern="(?:30))|(?:(?:0[13578]|1[02])-31))/(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])/(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])">
                                </div>
                            </div>
                            <div class="col-12">
